...
int pdlf::Robot::global_speed = 150; //was 150
...
void pdlf::Robot::pdLineFollow(void)
{
  ...
  //bluetooth->println(weightedValueSum());
	...
	while (s_digital_reading[0] == 0 && 
      s_digital_reading[2] == 0 &&
      s_digital_reading[3] == 0 &&
      s_digital_reading[4] == 0 &&
      s_digital_reading[5] == 0 &&
      s_digital_reading[6] == 0 &&
      s_digital_reading[1] == 0 &&
      s_digital_reading[7] == 0){
        updateDigitalRead();
        run(Nowhere);       
      }
}
